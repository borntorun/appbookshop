...
(function() {
  ...
  function BookrecordCtrl( $scope, $rootScope, _lodash, bookconfig, bookrecord, notifier ) {
    ...
    model.config.authors.ttoptions = angular.extend(angular.copy(model.config.authors.ttoptions), {name: 'authors', remote: '/api/tables/author/search/%QUERY', prefetch: '/assets/data/authors.json'})
    model.config.languages.ttoptions = angular.extend(angular.copy(model.config.languages.ttoptions), {name: 'languages', remote: '/api/tables/language/search/%QUERY', prefetch: '/assets/data/languages.json'})
    model.config.countries.ttoptions = angular.extend(angular.copy(model.config.countries.ttoptions), {name: 'countries', remote: '/api/tables/country/search/%QUERY', prefetch: '/assets/data/countries.json'})
    model.config.publishers.ttoptions = angular.extend(angular.copy(model.config.publishers.ttoptions), {name: 'publishers', remote: '/api/tables/publisher/search/%QUERY', prefetch: '/assets/data/publishers.json'})
    model.config.categories.ttoptions = angular.extend(angular.copy(model.config.categories.ttoptions), {name: 'categories', remote: '/api/tables/category/search/%QUERY', prefetch: '/assets/data/categories.json'})
    model.config.keywords.ttoptions = angular.extend(angular.copy(model.config.keywords.ttoptions), {name: 'keywords', remote: '/api/tables/keyword/search/%QUERY', prefetch: '/assets/data/keywords.json'})
    model.config.translators.ttoptions = angular.extend(angular.copy(model.config.translators.ttoptions), {name: 'translators', remote: '/api/tables/authors/search/%QUERY', prefetch: '/assets/data/authors.json'})
